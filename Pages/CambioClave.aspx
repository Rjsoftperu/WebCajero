<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CambioClave.aspx.cs" Inherits="Pages_CambioClave" Title="Cambiar-Clave"  Async="true" %>
...
<body>
  ...
  <div class="container" class="table-responsive"> 
        ...
        <h2 class="text-info"> Cambio de Clave</h2>
        ...
        <tr>  
            <td >
            <h4 class="text-info">Ingrese Ping Actual</h4>
                <br />
            </td>
              
            <td align="rigth"> 
            <asp:TextBox ID="txtpinactual" runat="server" type="password" class="form-control" MaxLength="4" Width="300px" placeholder="Ping Actual"/><br />
            </td>
            <td>           
                <h4 >
                    <asp:Label ID="lblcliente" runat="server" Text="" CssClass="text-success"></asp:Label><br />
                </h4>
                <br />        
            </td>  
        </tr>
            <tr>  
            <td >
            <h4 class="text-info">Nuevo Ping</h4>
                <br />
            </td>
              
            <td align="rigth"> 
            <asp:TextBox ID="txtpnuevo1" runat="server" type="password" class="form-control" MaxLength="4" Width="300px" placeholder="Ping Nuevo"/><br />
            <br />      
            </td>  
        </tr>
                <tr>  
            <td >
            <h4 class="text-info">Confirmar Nuevo Ping</h4>
                <br />
            </td>
              
            <td align="rigth"> 
            <asp:TextBox ID="txtpnuevo2" runat="server" type="password" class="form-control" MaxLength="4" Width="300px" placeholder="Respita Ping Nuevo"/><br />
            <br />      
            </td>  
        </tr>
            <tr>
       ...
       <td align="center" colspan="3">
           ...
           <br />
           <br />
        <asp:Button ID="btncambiar" runat="server" Text="Aceptar" CssClass="btn btn-lg btn-primary btn-block"  Height="40px" Width="260px" />  <br />
